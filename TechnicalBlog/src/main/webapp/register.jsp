...
<body>
	...
	<main
		class="d-flex align-items-center jumbotron bg-dark text-white bannerbg"
						...
						<div class="card-body">
							...
							<form action="RegisterServlet" method="post" id="regform">
								...
								<div class="form-group">
									...
									<button id="sendEmailBtn" onclick="sendOtp()">Get OTP</button>
								</div>

								<div class="form-group">
									<label for="exampleInputOtp">OTP</label> <input name="otp"
										type="text" class="form-control" id="exampleInputOtp"
								...
								<div class="form-group">
									<label for="gender">Select Gender</label> <br> <input
										name="gender" type="radio" value="Male" id="gender"> <span
										style="color: black">Male</span> &ensp; <input name="gender"
										type="radio" value="Female" id="gender"> <span
										style="color: black">Female</span>
								</div>
								...
								<div class="form-check">
									<input name="check" type="checkbox" class="form-check-input"
										...
										style="color: black">Agree to terms & conditions</label>
								</div>
								<br>
		...
		function sendOtp() {
			$('#sendEmailBtn').click(
					function() {
						...
						$.ajax({
							type : "get",
							url : "/TechnicalBlog/getOtp?email=" + $('#email').val(),
